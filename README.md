...
This repository contains a **Python simulator** built with the [QuTiP library](http://qutip.org/) for modeling **Transduction-Enabled Superconducting Quantum Repeater (TESQR)** protocols in entanglement distribution links.
